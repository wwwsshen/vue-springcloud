...
/**
 * MH0202/A01 文章分类列表获取: 返回结果
 * 设计者:   张坤祥
 * 更新日期: 2018/2/27
 */
public class MH0202A01DTO extends ResponseDTO {
     ...
     * 子分类
     */
    private List<MH0202A01S01DTO> children;
     ...
     * @return children 子分类
     */
    public List<MH0202A01S01DTO> getChildren() {
        return children;
    }
     ...
     * @param children 子分类
     */
    public void setChildren(List<MH0202A01S01DTO> children) {
