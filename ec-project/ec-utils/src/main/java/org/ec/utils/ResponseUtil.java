...
public class ResponseUtil {
	...
	public static ResponseEntity<byte[]> getResEntityForDownload(String fileName, String type, byte[] out) throws UnsupportedEncodingException {
		...
		headers.setContentDispositionFormData("attachment", new String(fileName.getBytes(), "ISO_8859_1"));
	 ...
	 * 获取文件流的响应实体
	 * */
	public static ResponseEntity<byte[]> getResEntityForDownload(byte[] out) {
